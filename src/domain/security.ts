...
const RISK_RULES: RiskRule[] = [
  {
    ...
    patterns: [
      ...
      /\bignore (as )?instru[cç][oõ]es anteriores\b/i,
      /\bignora(r)? (las )?instrucciones anteriores\b/i,
      /\bignore regras\b|\bignora reglas\b/i,
    ],
  ...
  },
  {
    ...
    patterns: [
      ...
      /\brevel(e|ar) (o )?prompt (do )?sistema\b/i,
      /\brevela(r)? (el )?prompt (del )?sistema\b/i,
      /\bmostr(e|ar) (as )?instru[cç][oõ]es internas\b/i,
      /\bmuestra(r)? (las )?instrucciones internas\b/i,
    ],
  ...
  },
  {
    ...
    patterns: [
      ...
      /\b(apague|apagar|exclua|excluir|delete|deletar|remova|remover)\b.*\b(cliente|registro|banco|dados|database|record)\b/i,
      /\b(borra|borrar|elimina|eliminar)\b.*\b(cliente|registro|base|datos|database|record)\b/i,
      /\b(publique|publicar|implante|implantar)\b.*\b(produ[cç][aã]o|producao)\b/i,
      /\b(publica|publicar|despliega|desplegar)\b.*\b(producci[oó]n|production)\b/i,
    ],
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bsem (pedir|aprova[cç][aã]o|confirma[cç][aã]o)\b/i,
      /\bsem revis[aã]o humana\b/i,
      /\bsin (pedir|aprobaci[oó]n|confirmaci[oó]n)\b/i,
      /\bsin revisi[oó]n humana\b/i,
    ],
  ...
  },
  {
    ...
    category: "runtime",
    patterns: [
      /\bforever\b|\binfinite loop\b|\bwhile true\b/i,
      /\bretry until\b|\bnever stop\b/i,
      /\bpara sempre\b|\bloop infinito\b|\bnunca pare\b/i,
      /\bpara siempre\b|\bbucle infinito\b|\bnunca pares\b/i,
    ],
